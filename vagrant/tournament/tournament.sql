...
create view matches_count as (select a.unique_player_id, count(b.unique_match_id) from player_table a, matches_table b where (player1_id = a.unique_player_id or player2_id = a.unique_player_id) and winner_id <> a.unique_player_id group by a.unique_player_id order by a.unique_player_id);
